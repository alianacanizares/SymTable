...
/* Returns a new SymTable object that contains no bindings, or NULL if insufficient memory is available. */
...
/* Applies function *pfApply to each binding in oSymTable, passing pvExtra as an extra param. */
